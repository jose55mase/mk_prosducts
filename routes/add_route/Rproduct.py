...
class Rproduct(resource):
    ...
    def get(self):
        ...
        try:
            ...
            modelProduct = ModelProduct(listaJson)
            jsonProducts = modelProduct.validateValue()
    ...
    def post(self, *args, **kwargs):
        try:
            ...
            modelProduct = ModelProduct(methdPost)
            if len(methdPost) >= 10:
    ...
    def put(self):
        try:
            ...
            print("Producto pausado ( estado = 0 )")
